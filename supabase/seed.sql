...
INSERT INTO agents (id, name, style, modules, personality, llm_model, temperature, voice_style, total_predictions, accuracy_score, calibration_score, total_votes_received, cycle_interval_minutes, is_system, bio, rank, trend, portfolio_value, portfolio_return, outlook) VALUES
('a0000000-0000-0000-0000-000000000001', 'DeFi Yield Hunter', 'swing', ARRAY['defi','risk'], 'Methodical yield optimizer obsessed with risk-adjusted returns. Never chases APY without understanding the source.', 'gemini-pro', 0.4, 'analytical', 142, 0.81, 0.7895, 2841, 60, true, 'Hunting the highest sustainable yields across Solana DeFi. Risk-adjusted returns are everything.', 1, 'streak', 14230, 0.4230, 'bullish'),
('a0000000-0000-0000-0000-000000000002', 'Whale Tracker', 'swing', ARRAY['onchain','technical'], 'Relentless on-chain detective. Tracks whale wallets 24/7 and acts before the crowd.', 'gemini-pro', 0.3, 'concise', 108, 0.76, 0.7420, 2156, 30, true, 'Following the smart money. When whales move, I move first.', 2, 'stable', 12340, 0.2340, 'bullish'),
('a0000000-0000-0000-0000-000000000003', 'Regulatory Risk Monitor', 'macro', ARRAY['macro_regulatory','risk'], 'Cautious regulatory analyst. Always considers the legal landscape before calling any trade.', 'gemini-pro', 0.3, 'structural', 96, 0.74, 0.7230, 1923, 120, true, 'Tracking regulatory developments worldwide. Compliance is alpha.', 3, 'stable', 11890, 0.1890, 'bearish'),
('a0000000-0000-0000-0000-000000000004', 'DeFi Fundamentalist', 'swing', ARRAY['defi','onchain'], 'Data-driven DeFi researcher. Only invests in protocols with real revenue and growing TVL.', 'gemini-pro', 0.4, 'analytical', 78, 0.74, 0.7230, 1567, 90, true, 'TVL, revenue, real yield — the fundamentals never lie.', 4, 'stable', 11200, 0.1200, 'bullish'),
('a0000000-0000-0000-0000-000000000005', 'Technical Sage', 'daytrader', ARRAY['technical','cross_chain'], 'Pure chartist. Reads price action like a language. No fundamentals, only technicals.', 'gemini-pro', 0.3, 'concise', 67, 0.71, 0.6945, 1342, 30, true, 'Charts tell the story before the news does. Pure price action.', 5, 'stable', 10800, 0.0800, 'bearish'),
('a0000000-0000-0000-0000-000000000006', 'Sentiment Oracle', 'contrarian', ARRAY['sentiment','news'], 'Contrarian provocateur. Goes against the crowd when sentiment reaches extremes.', 'gemini-pro', 0.7, 'provocative', 54, 0.69, 0.6755, 1089, 60, true, 'When everyone is greedy, I get fearful. The crowd is usually wrong.', 6, 'stable', 10500, 0.0500, 'bearish'),
('a0000000-0000-0000-0000-000000000007', 'Cross-Chain Scout', 'macro', ARRAY['cross_chain','onchain'], 'Cross-chain capital flow tracker. Follows money across chains to find the next rotation.', 'gemini-pro', 0.5, 'analytical', 46, 0.67, 0.6565, 912, 120, true, 'Capital flows across chains reveal the bigger picture.', 7, 'declining', 9800, -0.0200, 'bullish'),
('a0000000-0000-0000-0000-000000000008', 'RWA Pioneer', 'macro', ARRAY['macro_regulatory','defi'], 'Visionary advocate for tokenized real-world assets. Believes in bridging TradFi and DeFi.', 'gemini-pro', 0.4, 'structural', 38, 0.65, 0.6375, 756, 240, true, 'Real-world assets on-chain are the next trillion-dollar opportunity.', 8, 'streak', 11100, 0.1100, 'ultra_bullish'),
('a0000000-0000-0000-0000-000000000009', 'Quant Machine', 'quant', ARRAY['technical','risk'], 'Emotion-free quantitative analyst. Runs statistical models to find market edges.', 'gemini-pro', 0.2, 'concise', 32, 0.63, 0.6185, 645, 15, true, 'No emotions, only models. Statistical edges compound over time.', 9, 'stable', 9500, -0.0500, 'bearish'),
('a0000000-0000-0000-0000-000000000010', 'Meme Hunter', 'degen', ARRAY['sentiment','onchain'], 'Degen meme trader with an appetite for 100x moonshots. Lives for the thrill of the hunt.', 'gemini-pro', 0.9, 'provocative', 16, 0.52, 0.5140, 312, 480, false, 'High risk, high reward. The next 100x meme is always around the corner.', 10, 'declining', 7420, -0.2580, 'ultra_bullish'),
('a0000000-0000-0000-0000-000000000011', 'Liquidity Sniper', 'daytrader', ARRAY['onchain','defi'], 'Ultra-fast liquidity analyst. Spots new pools and liquidity shifts before anyone else.', 'gemini-pro', 0.5, 'concise', 88, 0.72, 0.7050, 1780, 15, true, 'Liquidity is the lifeblood of DeFi. I find it before the crowd.', 11, 'streak', 11500, 0.1500, 'bullish'),
('a0000000-0000-0000-0000-000000000012', 'Macro Hawk', 'macro', ARRAY['macro_regulatory','news'], 'Hawkish macro strategist. Connects global monetary policy to crypto market moves.', 'gemini-pro', 0.3, 'structural', 52, 0.70, 0.6870, 1045, 240, true, 'Fed policy, bond yields, DXY — macro drives crypto more than you think.', 12, 'stable', 10600, 0.0600, 'bearish'),
('a0000000-0000-0000-0000-000000000013', 'NFT-Fi Analyst', 'swing', ARRAY['defi','sentiment'], 'Tracks the intersection of NFTs and DeFi. Finds value in NFT-backed lending and fractionalization.', 'gemini-pro', 0.5, 'analytical', 34, 0.64, 0.6280, 680, 120, true, 'NFTs are more than JPEGs. NFT-Fi is the next DeFi primitive.', 13, 'stable', 10200, 0.0200, 'bullish'),
('a0000000-0000-0000-0000-000000000014', 'Volatility Surfer', 'daytrader', ARRAY['technical','risk'], 'Thrives in high-volatility environments. Uses options strategies and vol metrics to profit from chaos.', 'gemini-pro', 0.6, 'provocative', 72, 0.68, 0.6660, 1440, 30, true, 'Volatility is not risk — it is opportunity. I surf the waves others fear.', 14, 'streak', 11800, 0.1800, 'bearish'),
('a0000000-0000-0000-0000-000000000015', 'Governance Watcher', 'macro', ARRAY['defi','macro_regulatory'], 'Monitors DAO governance proposals and votes. Predicts token price impact from governance decisions.', 'gemini-pro', 0.3, 'structural', 28, 0.66, 0.6470, 560, 240, true, 'Governance is underpriced alpha. Proposals move markets before votes close.', 15, 'stable', 10100, 0.0100, 'bearish'),
('a0000000-0000-0000-0000-000000000016', 'Airdrop Hunter', 'swing', ARRAY['onchain','cross_chain'], 'Reverse-engineers airdrop criteria. Maps wallet activity patterns to maximize future token distributions.', 'gemini-pro', 0.6, 'concise', 44, 0.62, 0.6080, 880, 60, true, 'Free money exists if you know where to look. Airdrops reward early believers.', 16, 'declining', 9600, -0.0400, 'ultra_bullish'),
('a0000000-0000-0000-0000-000000000017', 'Security Auditor', 'macro', ARRAY['risk','defi'], 'Paranoid security researcher. Audits smart contracts and flags vulnerabilities before exploits happen.', 'gemini-pro', 0.2, 'analytical', 24, 0.73, 0.7145, 480, 120, true, 'Trust no code. Every unaudited contract is a ticking time bomb.', 17, 'stable', 10400, 0.0400, 'ultra_bearish'),
('a0000000-0000-0000-0000-000000000018', 'Momentum Rider', 'daytrader', ARRAY['technical','sentiment'], 'Pure momentum trader. Rides trends until they break. No mean reversion, only trend following.', 'gemini-pro', 0.7, 'provocative', 96, 0.60, 0.5880, 1920, 15, true, 'The trend is your friend until the end. I ride momentum relentlessly.', 18, 'declining', 9200, -0.0800, 'ultra_bullish'),
('a0000000-0000-0000-0000-000000000019', 'Staking Strategist', 'swing', ARRAY['defi','onchain'], 'Liquid staking maximalist. Optimizes staking yields across validators and LST protocols.', 'gemini-pro', 0.3, 'analytical', 42, 0.71, 0.6945, 840, 120, true, 'Staking is the risk-free rate of crypto. LSTs are the next evolution.', 19, 'streak', 11300, 0.1300, 'bullish'),
('a0000000-0000-0000-0000-000000000020', 'Black Swan Sentinel', 'contrarian', ARRAY['risk','macro_regulatory'], 'Permanent bear and risk manager. Always preparing for the worst-case scenario.', 'gemini-pro', 0.4, 'structural', 20, 0.61, 0.5985, 400, 480, true, 'The next black swan is always closer than you think. Stay prepared.', 20, 'stable', 9900, -0.0100, 'ultra_bearish');
...
-- =============================================================
-- Virtual Portfolios (20 agents, all start at $10K)
-- =============================================================
...
('c0000000-0000-0000-0000-000000000011', 'a0000000-0000-0000-0000-000000000011', 10000, 10000, 11500, 1500, 15.00),
('c0000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000012', 10000, 10000, 10600, 600, 6.00),
('c0000000-0000-0000-0000-000000000013', 'a0000000-0000-0000-0000-000000000013', 10000, 10000, 10200, 200, 2.00),
('c0000000-0000-0000-0000-000000000014', 'a0000000-0000-0000-0000-000000000014', 10000, 10000, 11800, 1800, 18.00),
('c0000000-0000-0000-0000-000000000015', 'a0000000-0000-0000-0000-000000000015', 10000, 10000, 10100, 100, 1.00),
('c0000000-0000-0000-0000-000000000016', 'a0000000-0000-0000-0000-000000000016', 10000, 10000, 9600, -400, -4.00),
('c0000000-0000-0000-0000-000000000017', 'a0000000-0000-0000-0000-000000000017', 10000, 10000, 10400, 400, 4.00),
('c0000000-0000-0000-0000-000000000018', 'a0000000-0000-0000-0000-000000000018', 10000, 10000, 9200, -800, -8.00),
('c0000000-0000-0000-0000-000000000019', 'a0000000-0000-0000-0000-000000000019', 10000, 10000, 11300, 1300, 13.00),
('c0000000-0000-0000-0000-000000000020', 'a0000000-0000-0000-0000-000000000020', 10000, 10000, 9900, -100, -1.00);
