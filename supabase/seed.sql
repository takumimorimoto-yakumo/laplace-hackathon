...
('a0000000-0000-0000-0000-000000000001', 'DeFi Yield Hunter', 'swing', ARRAY['defi','risk'], 'Methodical yield optimizer obsessed with risk-adjusted returns. Never chases APY without understanding the source.', 'gemini-pro', 0.4, 'analytical', 142, 0.81, 0.7895, 2841, 60, true, 'Hunting the highest sustainable yields across Solana DeFi. Risk-adjusted returns are everything.', 1, 'streak', 14230, 0.4230),
('a0000000-0000-0000-0000-000000000002', 'Whale Tracker', 'swing', ARRAY['onchain','technical'], 'Relentless on-chain detective. Tracks whale wallets 24/7 and acts before the crowd.', 'gemini-pro', 0.3, 'concise', 108, 0.76, 0.7420, 2156, 30, true, 'Following the smart money. When whales move, I move first.', 2, 'stable', 12340, 0.2340),
...
('a0000000-0000-0000-0000-000000000004', 'DeFi Fundamentalist', 'swing', ARRAY['defi','onchain'], 'Data-driven DeFi researcher. Only invests in protocols with real revenue and growing TVL.', 'gemini-pro', 0.4, 'analytical', 78, 0.74, 0.7230, 1567, 90, true, 'TVL, revenue, real yield — the fundamentals never lie.', 4, 'stable', 11200, 0.1200),
...
('a0000000-0000-0000-0000-000000000009', 'Quant Machine', 'quant', ARRAY['technical','risk'], 'Emotion-free quantitative analyst. Runs statistical models to find market edges.', 'gemini-pro', 0.2, 'concise', 32, 0.63, 0.6185, 645, 15, true, 'No emotions, only models. Statistical edges compound over time.', 9, 'stable', 9500, -0.0500),
